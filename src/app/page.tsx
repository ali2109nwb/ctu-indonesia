  ...
  return (
    <MotionDiv>
      ...
      <main className="relative z-10 flex flex-col-reverse p-10 md:px-24 lg:pt-16 mt-16 mb-40">
        ...
        {/* Text Section */}
        <motion.div variants={SLIDE_LEFT} className="space-y-2 mb-20">
        ...
        {/* Button Section */}
        <motion.div variants={SLIDE_LEFT} className="relative z-10 mb-10">
          <Link href="/news" className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 
            font-medium rounded-xl text-2xl px-10 py-3 opacity-100 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">
            More News
          </Link>
        </motion.div>
      ...
      <div className="relative z-0">
        <img src={bg.src} className="object-cover w-full h-auto" alt="" />
        ...
        <div className="absolute z-10 top-0 left-0 ml-8 mt-20">
          ...
          <div className="relative pl-5 z-10 mt-5 grid grid-cols-2 gap-10">
            <div>
              <h3 className="text-2xl font-bold text-white">Featured Solution</h3>
              <p className="text-white">
                Lorem ipsum dolor, sit amet consectetur adipisicing elit. Voluptatem error eius modi incidunt suscipit eum doloribus.
              </p>
            </div>

            <div className="grid grid-cols-11 gap-4">
              <div className="mt-5 col-span-5">
                <div className="bg-white rounded-lg mb-10 p-5">
