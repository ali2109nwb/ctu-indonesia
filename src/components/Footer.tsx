        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-x-20 gap-y-6 text-center md:text-left w-full md:w-auto">
          <div>
            ...
            <ul className="space-y-2 text-gray-300 font-clash text-sm">
              ...
              <li><Link href="/product-device" className="hover:text-white">Product - Device</Link></li>
              <li><Link href="/product-display" className="hover:text-white">Product - Display</Link></li>
              <li><Link href="/contact" className="hover:text-white">Contact</Link></li>
              <li><Link href="/news" className="hover:text-blue-400 font-semibold">News</Link></li>
            </ul>
          </div>
          ...
          <div >
            ...
            <ul className="space-y-2 text-gray-300 font-clash text-sm">
              <li><Link href="#" className="hover:text-white">Wall Display</Link></li>
              <li><Link href="#" className="hover:text-white">Kiosk</Link></li>
              <li><Link href="#" className="hover:text-white">Videotron</Link></li>
              <li className="flex justify-center md:justify-start items-center">
                <Link href="#" className="hover:text-white">Smart Phone</Link>
          ...
          <div className="font-clash flex flex-col items-center md:items-start">
            ...
            <ul className="space-y-3 text-gray-300 font-clash text-sm md:justify-start items-center">
              <li className="flex items-center space-x-2">
                <Image src="/assets/icon/linkedin-icon-free-png.png" alt="LinkedIn" width={20} height={20} />
              ...
              <li className="flex items-center space-x-2">
                <Image src="/assets/icon/gmail.png" alt="Gmail" width={20} height={20} />
                <Link href="mailto:nuraliali2109@gmail.com" target="_blank" className="hover:text-white">Gmail</Link>
              </li>
              <li className="flex items-center space-x-2">
                <Image src="/assets/icon/WA.png" alt="WhatsApp" width={20} height={20} />
                <Link href="https://wa.me/6285710130984" target="_blank" className="hover:text-white">WhatsApp</Link>
              </li>
            </ul>
          </div>
